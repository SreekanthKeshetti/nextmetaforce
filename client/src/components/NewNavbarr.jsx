...
//           /*
//             UPDATED SPLIT CONTAINER:
//             We use justify-content: center to pack items in the middle.
//             We use a "Balancer" div on the left to offset the arrow on the right.
//           */
//           .mobile-split-container {
//             display: flex;
//             align-items: center;
//             justify-content: center; /* Packs everything to the center */
//             width: 100%;
//             border-bottom: 1px solid rgba(255, 255, 255, 0.1);
//             padding: 0;
//           }
...
//              No flex-grow here! It only takes up the space of the text.
//           */
//           .mobile-service-link {
//             padding: 1rem 0.5rem; /* Padding around text */
//             color: rgba(255, 255, 255, 0.85);
//             text-decoration: none;
//             font-weight: 500;
//           }
...
//           /*
//              Right Arrow & Left Balancer
//              Both have fixed width (e.g., 50px) to ensure perfect centering
//           */
//           .mobile-arrow-trigger, .mobile-balancer {
//             width: 50px;
//             height: 100%;
//             display: flex;
//             align-items: center;
...
//           /* The left one is invisible - just for spacing balance */
//           .mobile-balancer {
//             visibility: hidden;
//             pointer-events: none;
//           }
...
//                   {/* 1. LEFT BALANCER (Invisible, forces center alignment) */}
//                   <div className="mobile-balancer"></div>

//                   {/* 2. CENTER TEXT (Tightly packed with arrow) */}
//                   <Link
//                     to="/services"
