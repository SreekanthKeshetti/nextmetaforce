...
//     } else if (opt.id === "explore-services") {
//       await pushBot(
//         "We offer Digital Transformation, Software Development, IT Consulting, Cloud AI, Training & Enablement, Cloud & DevOps, and Web Development. Which one interests you?"
//       );
//       setFlow({ type: "service-flow", step: "service" });
//     } else if (opt.id === "careers") {
//       await pushBot(
...
//   // ✅ Plain JS version of submitFlow
//   const submitFlow = async (data, topic) => {
//     if (submitting) return;
//     setSubmitting(true);

//     try {
//       // Using browser fetch directly — no Node.js required
