      ...
      <section className="manifesto-section">
        ...
        <div className="manifesto-content">
          ...
          {[
            ...
            {
              text: "We don’t just implement systems. We ignite ecosystems — where data breathes, people connect, and innovation compounds.",
            },
            {
              text: "Every engagement is a force multiplier — blending human empathy with engineered precision. We turn CRMs into living engines of growth, clouds into catalysts of possibility, and AI into augmentation that empowers, not replaces.",
            },
            {
              text: "Our expertise spans Salesforce, Oracle, and Microsoft Dynamics — but our essence transcends platforms. We’re architects of outcomes, designing intelligent, scalable, and adaptive systems that think forward.",
            },
            {
              text: "From Manufacturing to Financial Services, Telecom to Public Sector, Health to Nonprofits — we build digital experiences that don’t just transform business, they transform belief.",
            },
            {
              text: "We champion the frontier — exploring Generative AI, Web3, Blockchain, and Machine Learning to craft solutions that move faster, think deeper, and last longer.",
            },
            {
              text: "Our people are our power source. We nurture curiosity, celebrate bold thinking, and honor balance — because transformation without humanity is just transaction.",
            },
          ].map((item, i) => (
            <motion.p
              key={i}
          ...
          >
            ...
            <br />
            NextMetaForce — Empowering the human side of transformation.
          </motion.p>
        </div>
      </section>
    </>
