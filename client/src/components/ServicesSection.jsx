...
// /* 🌐 Enhanced visible grid overlay */
// .hero-beliefs-section::before {
//   content: "";
//   position: absolute;
//   inset: 0;
//   background-image:
//     linear-gradient(to right, rgba(255,255,255,0.09) 1.5px, transparent 1px),
//     linear-gradient(to bottom, rgba(255,255,255,0.09) 1.5px, transparent 1px);
...
// /* ✨ glowing orange-red spillovers */
// .hero-beliefs-section::after {
//   content: "";
//   position: absolute;
//   inset: 0;
//   background:
//     radial-gradient(circle at 70% 30%, rgba(255,115,0,0.3), transparent 60%),
//     radial-gradient(circle at 20% 80%, rgba(255,0,60,0.3), transparent 60%),
//     radial-gradient(circle at 90% 80%, rgba(255,150,0,0.25), transparent 60%);
//   filter: blur(160px);
//   z-index: 0;
//   opacity: 0.9;
// }
...
// /* heading */
// .text-gradient {
//   background: linear-gradient(to right, #ffb100, #ff7300, #ff003c);
//   -webkit-background-clip: text;
//   -webkit-text-fill-color: transparent;
//   font-size: 2.4rem;
...
//   box-shadow: 0 0 10px rgba(255,115,0,0.15);
...
//       <section className="hero-beliefs-section text-center">
//         <Container className="position-relative">
//           <h1 className="fw-normal text-gradient">Our Core Beliefs</h1>
//           <p className="lead">
//             Shaping the future of business with cloud-first and AI-powered
//             solutions.
//           </p>
...
//                       className="icon-circle me-3"
//                       style={{
//                         background: `linear-gradient(135deg, ${b.color}55, ${b.color}22)`,
