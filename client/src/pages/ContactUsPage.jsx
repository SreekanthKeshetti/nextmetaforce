...
//   font-weight: 400;
//   line-height: 1.6;
//   margin-left: 0.3rem; /* gentle left shift for text alignment */
...
function ContactUsPage() {
  ...
  text-overflow: unset; /* remove the ... */
  max-width: 100%;
}
          ...
          @media (max-width: 991px) {
            .hero-subheading {
              white-space: normal; /* mobile - wrap naturally */
            }
          }
      ...
      <div className="contact-hero-section">
        <div className="hero-content">
          ...
          <p className="hero-subheading">
            Thanks for your interest in <strong>Nextmetaforce</strong>.<br />{" "}
            Let us connect over phone or email. we’ll connect you with the right
            person.
          </p>
        </div>
      </div>
