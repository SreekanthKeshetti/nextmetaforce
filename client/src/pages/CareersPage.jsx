...
const CareersPage = () => {
  const values = [
    {
      icon: <FaUsers color="#e63946" />,
      title: "Collaborative Culture",
      text: "We foster teamwork, transparency, and shared success in every project we deliver.",
    },
    {
      icon: <FaLightbulb color="#f4a261" />,
      title: "Innovation First",
      text: "We embrace creativity and forward-thinking ideas that push digital boundaries.",
    },
    {
      icon: <FaHandshake color="#2a9d8f" />,
      title: "Integrity & Trust",
      text: "Our partnerships are built on transparency, honesty, and mutual respect.",
    },
    {
      icon: <FaLaptopCode color="#457b9d" />,
      title: "Continuous Learning",
      text: "We empower our teams to explore new technologies and grow professionally.",
    },
  ];
            ...
            <Row className="g-4">
              {values.map((item, index) => (
                <Col key={index} md={6} lg={3} className="d-flex">
                  <motion.div
                    whileHover={{ y: -10 }}
                    className="value-card text-center p-4 shadow-sm rounded-4 h-100 w-100"
                  >
                    <div className="icon mb-3">{item.icon}</div>
                    <h5 className="fw-semibold mb-2 careerTitle">
                      {item.title}
                    </h5>
              ...
              {openings.map((job, i) => (
                <Col md={6} lg={4} key={i} className="d-flex">
                  <motion.div whileHover={{ scale: 1.03 }} className="w-100">
                    <Card className="job-card border-0 shadow-sm rounded-4 h-100 w-100">
                      <Card.Body className="d-flex flex-column justify-content-between">
                        <div>
                          <Card.Title className="fw-bold careerTitle mb-2">
                            {job.title}
                          </Card.Title>
        ...
        <section className="text-center py-5">
          <Container>
            ...
            <motion.p
              ...
              whileInView={{ opacity: 1 }}
              transition={{ delay: 0.2, duration: 1 }}
              className="lead  mx-auto CareerText"
              style={{ maxWidth: "700px" }}
            >
              “At NextMetaForce, we believe work should inspire and challenge —
              where innovation meets impact, and your ideas help shape the
